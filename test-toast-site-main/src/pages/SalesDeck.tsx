...
const slides = [
  ...
  },
  {
    ...
    features: [
      ...
      "No-code visual test automation for non-technical users",
      "Automatic automation code generation (Java/Python/JS)",
      "AI Governance with safety controls & audit trails",
      "Integrated API, Performance & UI testing",
      "Real-time analytics and AI-powered insights",
      "Seamless CI/CD & Jira/Azure DevOps integration",
    ],
  },
  {
    id: 4,
    ...
    features: [
      {
        ...
        description: "Generate comprehensive test cases from user stories using advanced AI models",
        benefit: "Save 70% of test case creation time",
      },
      {
        icon: MousePointer2,
        title: "No-Code Automation",
        description: "Create visual tests without coding - drag, drop, and execute",
        benefit: "Empower non-technical testers",
      },
      {
        icon: FileCode,
        title: "Smart Code Generation",
        description: "Auto-generate Page Objects, Step Definitions & Test Classes in Java/Python/JS",
        benefit: "Reduce automation development by 50%",
      },
      {
        icon: Shield,
        title: "AI Governance",
        description: "Safety controls, rate limiting, audit trails, and proven QA patterns",
        benefit: "Enterprise-grade AI controls",
      },
    ],
  },
  {
    ...
    features: [
      {
        icon: TestTube,
        title: "Integrated Testing Suite",
        description: "API, Performance (JMeter), and UI testing in one unified platform",
        benefit: "Single source of truth",
      },
      {
        icon: BarChart3,
        title: "AI Analytics Dashboard",
        description: "Real-time usage tracking, cost monitoring, and intelligent insights",
        benefit: "Data-driven decisions",
      },
      {
        icon: Search,
        title: "Semantic Search",
        description: "AI-powered search across test cases, patterns, and documentation",
        benefit: "Find anything instantly",
      },
      {
        icon: GitCompare,
        title: "Test Run Comparison",
        description: "Compare test runs side-by-side with detailed diff analysis",
        benefit: "Track quality trends",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: "Visual DOM analysis for accurate locator generation with 99% accuracy",
        benefit: "Bulletproof selectors",
      },
      {
        icon: GitBranch,
        title: "CI/CD Integration",
        description: "GitHub, Azure DevOps, and Jira connectivity with real-time sync",
        benefit: "Seamless DevOps workflow",
      },
      {
        icon: BookOpen,
        title: "Knowledge Base",
        description: "Built-in documentation with AI-powered assistance and patterns library",
        benefit: "Self-service learning",
      },
      {
        icon: Gauge,
        title: "Performance Testing",
        description: "HAR & Swagger to JMeter conversion with AI-optimized test scripts",
        benefit: "Instant performance tests",
      },
    ],
  },
  {
    ...
    subtitle: "Enterprise-Grade Controls for AI-Powered Testing",
    features: [
      {
        icon: Lock,
        title: "Safety Controls",
        description: "Configure rate limits, content filters, and generation boundaries",
      },
      {
        icon: Eye,
        title: "Audit Dashboard",
        description: "Complete visibility into all AI operations with detailed logs",
      },
      {
        icon: Activity,
        title: "Usage Analytics",
        description: "Track AI usage, costs, and performance across teams",
      },
      {
        icon: Brain,
        title: "Proven Patterns",
        description: "Leverage validated QA patterns with confidence scoring",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      { number: 2, icon: Brain, text: "AI Analyzes", description: "Generates test scenarios" },
      { number: 3, icon: CheckCircle, text: "Test Cases Created", description: "Comprehensive coverage" },
      { number: 4, icon: Code, text: "Automation Generated", description: "Code or No-Code" },
  ...
  },
  {
    ...
    stack: [
      { category: "AI Engine", items: ["OpenAI GPT-4 / GPT-5", "Vision API for DOM Analysis", "Semantic Search & Embeddings"] },
      { category: "Automation", items: ["Selenium WebDriver", "Apache JMeter", "Playwright (No-Code)"] },
      { category: "Platform", items: ["React + TypeScript", "Supabase Backend", "Edge Functions"] },
      { category: "Integration", items: ["GitHub API", "Azure DevOps", "Jira Cloud", "CI/CD Pipelines"] },
    ],
  },
  {
    id: 10,
    ...
    title: "Why Choose Us?",
    points: [
      { icon: Layers, title: "End-to-End Platform", description: "Complete testing lifecycle with code & no-code options" },
      { icon: Brain, title: "AI at Every Step", description: "From test design to defect reporting with governance" },
      { icon: MousePointer2, title: "No-Code First", description: "Empower anyone to create automated tests" },
      { icon: Shield, title: "Enterprise Ready", description: "AI safety controls, audit trails, and compliance" },
    ],
  },
  {
    id: 11,
    ...
    cases: [
      {
        ...
        description: "Scale testing with AI governance and complete audit trails",
      },
      {
        icon: Rocket,
        title: "Agile Development",
        description: "Keep pace with rapid sprint cycles using no-code automation",
      },
      {
        icon: Target,
        title: "QA Transformation",
        description: "Modernize testing with AI while maintaining control & compliance",
      },
      {
        icon: GitBranch,
        title: "DevOps Teams",
        description: "Integrate AI-powered testing seamlessly into CI/CD pipelines",
      },
    ],
  },
  {
        ...
        <div className="w-full max-w-6xl animate-fade-in">
          ...
          {slide.type === "governance" && (
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {slide.features?.map((feature, idx) => (
                  <Card key={idx} className="p-6 border-2 border-primary/20 bg-primary/5 hover:shadow-medium transition-all">
                    <div className="flex items-start gap-4">
              ...
              <div className="text-center pt-4">
                <p className="text-sm text-muted-foreground">
                  Enterprise-ready AI with full visibility and control
                </p>
              </div>
            </div>
          )}

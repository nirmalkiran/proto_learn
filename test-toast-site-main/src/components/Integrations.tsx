          ...
          <CardContent className="space-y-4">
            ...
            {showApiKeyForm === 'openai' && (
              <>
                ...
                <div className="space-y-2">
                  <Label htmlFor="openaiEmbeddingDeployment">Embedding Deployment (for semantic search)</Label>
                  <Input
                    id="openaiEmbeddingDeployment"
                    placeholder="text-embedding-3-small"
                    value={openAiConfig.embeddingDeployment}
                    onChange={(e) => setOpenAiConfig(prev => ({ ...prev, embeddingDeployment: e.target.value }))}
                  />
                  <p className="text-xs text-muted-foreground">
                    Required for AI-powered semantic search. Common models: text-embedding-3-small, text-embedding-ada-002
                  </p>
                </div>
                <div className="space-y-2">

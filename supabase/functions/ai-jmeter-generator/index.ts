...
serve(async (req) => {
  ...
  try {
    ...
    console.log('AI JMeter Generator called with config:', config);
    ...
    const { jmeterXml, usage } = await generateJMeterWithAI(spec, config, aiProvider);
    ...
    console.log('Generated JMeter XML successfully');

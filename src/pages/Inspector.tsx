...
import { ArrowLeft, RefreshCw, Copy, ChevronRight, ChevronDown } from "lucide-react";
...
export default function Inspector() {
  ...
  const generateLocators = (node: UINode) => {
    ...
    if (node.resourceId) {
      const id = node.resourceId.split("/").pop();
      locators.push({
        type: "ID",
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="container mx-auto max-w-6xl">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">Locator Finder / Inspector</h1>
        </div>
